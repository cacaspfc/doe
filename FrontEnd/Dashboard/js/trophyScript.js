        ...
        for (i = 0; i < data.trofeus.length; i++) {
          if (data.trofeus[i] == 'T0') {
            ...
            for (let i = 0; i < lista; i++) {
              document.querySelectorAll('#T0')[i].style.filter =
                'grayscale(0%)';
            }
          }
          ...
          if (data.trofeus[i] == 'T1') {
            ...
            for (let i = 0; i < lista; i++) {
              document.querySelectorAll('#T1')[i].style.filter =
                'grayscale(0%)';
            }
          }
          ...
          if (data.trofeus[i] == 'T2') {
            ...
            for (let i = 0; i < lista; i++) {
              document.querySelectorAll('#T2')[i].style.filter =
                'grayscale(0%)';
            }
          }
          ...
          if (data.trofeus[i] == 'T3') {
            ...
            for (let i = 0; i < lista; i++) {
              document.querySelectorAll('#T3')[i].style.filter =
                'grayscale(0%)';
            }
          }
          if (data.trofeus[i] == 'T4') {
            ...
            for (let i = 0; i < lista; i++) {
              document.querySelectorAll('#T4')[i].style.filter =
                'grayscale(0%)';
            }
          }
          if (data.trofeus[i] == 'SF1') {
            ...
            for (let i = 0; i < lista; i++) {
              document.querySelectorAll('#SF1')[i].style.filter =
                'grayscale(0%)';
            }
          }
          if (data.trofeus[i] == 'SF2') {
            ...
            for (let i = 0; i < lista; i++) {
              document.querySelectorAll('#SF2')[i].style.filter =
                'grayscale(0%)';
            }
          }
          if (data.trofeus[i] == 'SF3') {
            ...
            for (let i = 0; i < lista; i++) {
              document.querySelectorAll('#SF3')[i].style.filter =
                'grayscale(0%)';
            }
          }
          if (data.trofeus[i] == 'SF4') {
            ...
            for (let i = 0; i < lista; i++) {
              document.querySelectorAll('#SF4')[i].style.filter =
                'grayscale(0%)';
            }
          }
        }
